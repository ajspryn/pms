<div class="d-flex justify-content-between align-items-center ">
    ...
    <div class="d-flex justify-content-center justify-content-md-end">
      ...
      <button class="create-new btn btn-primary" data-bs-toggle="modal" data-bs-target="#createcomponent"><i class="ti ti-plus me-sm-1"></i>Add New</button>
    </div>
</div>  
    ...
    <tbody>
            ...
            <tr>
                ...
                <td>
                    ...
                    <a class="btn submit-btn editcomponent-btn" data-id="{{ $component->id }}" data-bs-toggle="modal" data-bs-target="#editcomponent" ><i class=" ti ti-edit ti-ms"></i></a>
                    @endcan
                ...
                <td>{{ $component->interval }}</td>
                <td>{{ $component->end_job }}</td>
...
<!-- Extra Large Modal -->
<div class="modal fade" id="createcomponent" tabindex="-1" aria-hidden="true">
    <div class="modal-dialog modal-xl" role="document">
      <div class="modal-content">
        ...
        <form class="row g-3" onsubmit="return true" method="POST" action="{{ route('component.store') }}" enctype="multipart/form-data">
            @csrf
            <div class="row g-2">
            <div class="col mb-0">
            ...
            <div class="col mb-0">
                <label class="form-label" for="form-repeater-1-2">Code Component</label>
                      <input type="text" id="form-repeater-1-2" class="form-control" placeholder="Format 000" name="code_component" />
            </div>
        </div>
            <div class="row g-2">
            <div class="col mb-0">
