<div class="modal fade" id="editpart" tabindex="-1" aria-hidden="true">
    <div class="modal-dialog modal-xl" role="document">
      <div class="modal-content">
        ...
        <form class="row g-3" onsubmit="return true" method="POST" action="{{ route('part.update', $part->pluck('id')) }}" enctype="multipart/form-data">
            @csrf
            @method('put')
            <div class="row g-2">
                <div class="col mb-0">
                ...
                <div class="col mb-0">
                    ...
                    <input type="text" id="code_part" class="form-control" placeholder="Format 000" name="code_part" />
                </div>
        </div>
            <div class="row g-2">
            <div class="col mb-0">
