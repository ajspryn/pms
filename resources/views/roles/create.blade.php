...
<div class="container-xxl flex-grow-1 container-p-y">
    <h4 class="fw-semibold mb-4">Create Role</h4>
    <div class="row">
        ...
        <div class="form-floating">
            {!! Form::text('name', null, array('placeholder' => ' ','class' => 'form-control', 'aria-describedby' => 'floatingInputHelp')) !!}
        ...
        <div class="row gy-3">
          ...
          <div class="col-md-3 col-6">
            <div class="d-flex align-items-center">
                ...
                ?>
                <p>{{ Form::checkbox('permission[]', $perm->id, false, array('class' => 'form-check-input','type'=>'checkbox')) }}
