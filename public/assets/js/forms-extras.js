...
$(function () {
    ...
    if (formRepeater.length) {
        ...
        formRepeater.on("submit", function (e) {
            // Mengambil elemen input di dalam form yang sedang aktif
            var inputElements = $(this).find("input, select, textarea");

            // Mengecek validitas setiap elemen input
            ...
            // Jika form tidak valid, hentikan pengiriman dan tampilkan pesan kesalahan
            if (!isFormValid) {
                e.preventDefault();
                e.stopPropagation();
                return false;
        ...
        formRepeater.repeater({
            ...
            hide: function (e) {
                // Membuat elemen style untuk SweetAlert
                var style = document.createElement("style");
                document.head.appendChild(style);

                // Menambahkan aturan CSS untuk SweetAlert
                ...
                Swal.fire({
                    title: "Apakah Anda yakin ingin menghapus elemen ini?",
                    icon: "warning",
